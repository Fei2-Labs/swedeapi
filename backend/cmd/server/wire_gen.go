...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	windsurfAuthService := service.NewWindsurfAuthService(proxyRepository)
	...
	windsurfOAuthHandler := admin.NewWindsurfOAuthHandler(windsurfAuthService)
